...
export default function MobilePhotoGallery() {
  const photos = [
    ...
    'https://photos.rever.cyou/prewed-album/ZEN08466-Edit.jpg',
    'https://photos.rever.cyou/prewed-album/ZEN08483-Edit.jpg',
    'https://photos.rever.cyou/prewed-album/ZEN08489-Edit.jpg',
    'https://photos.rever.cyou/prewed-album/ZEN08491-Edit.jpg',
    'https://photos.rever.cyou/prewed-album/ZEN08497-Edit.jpg',
    'https://photos.rever.cyou/prewed-album/ZEN08502-Edit.jpg',
    'https://photos.rever.cyou/prewed-album/ZEN08518-Edit.jpg',
    'https://photos.rever.cyou/prewed-album/ZEN08526-Edit.jpg',
    'https://photos.rever.cyou/prewed-album/ZEN08529-Edit.jpg',
    'https://photos.rever.cyou/prewed-album/ZEN08562-Edit.jpg',
  ...
  return (
    <section className="xl:hidden py-20 px-4" style={{ backgroundColor: theme.colors.primary[900] }}>
      <motion.div
