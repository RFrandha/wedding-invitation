...
const locations: Record<Location, LocationData> = {
  ...
  bukittinggi: {
    ...
    mapUrl: 'https://maps.app.goo.gl/5neKoLHGiaxWkSPTA',
    embedUrl: 'https://www.google.com/maps/embed?pb=!1m14!1m8!1m3!1d251.0226123753588!2d100.37314492327907!3d-0.2888642445912517!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x2fd539d072d51fc7%3A0xcd227a1eecf18eaa!2sBungo%20bed%20%26%20breakfast%20workation!5e0!3m2!1sen!2sid!4v1763891677366!5m2!1sen!2sid'
  }
}
    ...
    <section className="py-20 px-4 relative overflow-hidden" style={getBgColor(theme.colors.primary[800])}>
      ...
      <div className="absolute inset-0 opacity-5">
        <div className="absolute top-16 right-16 w-80 h-80 rounded-full blur-3xl"
             style={getBgColor(theme.colors.secondary[500])}></div>
        <div className="absolute bottom-16 left-16 w-80 h-80 rounded-full blur-3xl"
             style={getBgColor(theme.colors.secondary[400])}></div>
      </div>
      ...
      <div className="max-w-4xl mx-auto relative z-10">
        ...
        >
          ...
          <div className="flex justify-center gap-3 mt-8">
            ...
            <button
              ...
              style={selectedLocation === 'bukittinggi' ? getBgColor(theme.colors.secondary[500]) : {
                backgroundColor: 'transparent',
                border: `1px solid ${hexToRgba(theme.colors.secondary[500], 0.3)}`
              }}
            >
        ...
        >
          <Card className="overflow-hidden shadow-2xl hover:shadow-3xl transition-all duration-500" style={{
            ...getBgColor(theme.colors.primary[700], 0.3),
            backdropFilter: 'blur(12px)',
            borderColor: hexToRgba(theme.colors.secondary[500], 0.3)
          }}>
            ...
            <div className="h-64 md:h-80 relative overflow-hidden">
              ...
              {/* Decorative border */}
              <div
                className="absolute inset-0 border border-white/30 transition-colors duration-500 rounded-t-lg pointer-events-none"></div>
            </div>
              ...
              <div className="space-y-4">
                ...
                >
                  <div className="flex items-center space-x-3">
                    <div
                      className="p-1 bg-white/20 rounded-full group-hover:bg-white/30 transition-colors duration-300">
