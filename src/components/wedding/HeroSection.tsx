...
export default function HeroSection() {
  return (
    <section className="min-h-screen bg-gradient-to-br from-primary-50 via-neutral-50 to-secondary-50 flex items-center justify-center p-4 relative overflow-hidden">
        ...
        >
          ...
          <div className="text-center">
            <motion.div
              ...
              className="relative"
            >
              <div className="absolute inset-0 bg-gradient-to-br from-primary-200/50 to-primary-300/50 rounded-full blur-md transform scale-110"></div>
              <Avatar className="w-32 h-32 md:w-40 md:h-40 mx-auto mb-4 border-4 border-white/60 shadow-2xl relative z-10">
                ...
                <AvatarFallback className="text-2xl font-serif bg-gradient-to-br from-primary-100 to-primary-200 text-primary-700">R</AvatarFallback>
              </Avatar>
            </motion.div>
          ...
          <motion.div
            ...
            className="text-4xl md:text-6xl font-serif text-transparent bg-gradient-to-br from-primary-500 to-secondary-600 bg-clip-text drop-shadow-sm"
          >
            &
          </motion.div>
          ...
          <div className="text-center">
            <motion.div
              ...
              className="relative"
            >
              <div className="absolute inset-0 bg-gradient-to-br from-secondary-200/50 to-secondary-300/50 rounded-full blur-md transform scale-110"></div>
              <Avatar className="w-32 h-32 md:w-40 md:h-40 mx-auto mb-4 border-4 border-white/60 shadow-2xl relative z-10">
